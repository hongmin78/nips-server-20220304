...
const TOKENLEN = 48;
let { Op } = db.Sequelize;
let nettype = "BSC-MAINNET";
// let nettype = "ETH-TES TNET";
let rmqq = "tasks";
...
router.post("/init/rounds", async (req, res) => {
  ...
  await updaterow("ballots", { nettype }, { counthelditems: 0, lastroundmadepaymentfor: -4, isdelinquent: 0 }); // update ballots set active=1 where nettype ='ETH_T ESTNET';
